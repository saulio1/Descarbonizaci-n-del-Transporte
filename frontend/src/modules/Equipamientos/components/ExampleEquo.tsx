...
import Table from './TablaEquipamientos'
...
function createData(
  ...
  return { id, name, categoria, fecha, ubicación,estado }
}

//All your data
const allRows = [
  createData(1, 'Saulio', "02081960207", "53976500", "saulio@icloud.com", "Chofer" ),
...
const actions: Action[] = [
  ...
  return (
    <>
      <h1 style={{ textAlign: 'center', color:"blue" }}>Módulo de Equipamientos</h1>
      <br />
      <Table
